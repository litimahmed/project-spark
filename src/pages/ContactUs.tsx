              ...
              <Card>
                <CardContent className="pt-6">
                  ...
                  <div className="flex flex-wrap justify-center gap-4">
                    {apiData.site_web && (
                      <a href={apiData.site_web} target="_blank" rel="noopener noreferrer"
                    ...
                    {apiData.facebook && (
                      <a href={apiData.facebook} target="_blank" rel="noopener noreferrer"
                         className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors">
                    ...
                    {apiData.instagram && (
                      <a href={apiData.instagram} target="_blank" rel="noopener noreferrer"
                         className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors">
                        <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {apiData.tiktok && (
                      <a href={apiData.tiktok} target="_blank" rel="noopener noreferrer"
                         className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors">
                        <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {apiData.linkedin && (
                      <a href={apiData.linkedin} target="_blank" rel="noopener noreferrer"
                         className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors">
                        <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
                    ...
                    {apiData.x && (
                      <a href={apiData.x} target="_blank" rel="noopener noreferrer"
                         className="flex items-center gap-2 px-4 py-2 rounded-lg bg-primary/10 hover:bg-primary/20 transition-colors">
                        <svg className="w-5 h-5 text-primary" fill="currentColor" viewBox="0 0 24 24">
              ...
              <CardContent className="pt-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <Button type="submit" size="lg" className="w-full gap-2" disabled={mutation.isPending}>
                    ...
                    {mutation.isPending ? "Sending..." : t("contactPage.submit")}
                  </Button>
                </form>
              </CardContent>
            </Card>
